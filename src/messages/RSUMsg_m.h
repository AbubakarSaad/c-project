...
/**
 * Class generated from <tt>src/messages/RSUMsg.msg:29</tt> by nedtool.
 * <pre>
 * packet RSUMsg extends WaveShortMessage
 * {
 *     int psid = -100;
 *     string msg = "from rsu";
 * }
 * </pre>
 */
class RSUMsg : public ::WaveShortMessage
{
  protected:
    int psid;
