...
/**
 * Class generated from <tt>src/messages/BeaconMsg.msg:30</tt> by nedtool.
 * <pre>
 * packet BeaconMsg extends WaveShortMessage
 * {
 *     // meta info
 ...
 * </pre>
 */
class BeaconMsg : public ::veins::WaveShortMessage
{
  protected:
    Coord messageOriginPosition;
    double senderDirection;
